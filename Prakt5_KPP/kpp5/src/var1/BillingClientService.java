...
public BillingClientService (BillingService bs,DataInputStream dis,DataOutputStream dos){ this.bs = bs;
...
void getCardBalance() throws IOException{ String card = dis.readUTF();
